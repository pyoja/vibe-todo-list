...
import { TermsModal, PrivacyModal } from "@/components/auth/legal-dialogs";
    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-white dark:bg-black p-4">
      ...
      <div className="w-full max-w-sm space-y-8 text-center">
        ...
        <div className="grid gap-4">
          <Button
            variant="outline"
            className="w-full h-12 text-base font-medium rounded-xl border-slate-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-slate-900 dark:text-white hover:bg-slate-50 dark:hover:bg-zinc-700 relative transition-colors"
            onClick={async () => {
      ...
      <PrivacyModal isOpen={showPrivacy} onClose={setShowPrivacy} />
    </div>
  );
}

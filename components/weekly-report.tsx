  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger asChild>
        <Button
          variant="ghost"
          className="text-blue-100/80 hover:text-white hover:bg-white/10 h-auto p-0 px-3 py-1.5 rounded-full flex gap-2 transition-colors self-end"
        >
          <BarChart3 className="w-4 h-4" />
          <span className="text-xs font-semibold">주간 리포트 보기</span>
        </Button>
      </DialogTrigger>
